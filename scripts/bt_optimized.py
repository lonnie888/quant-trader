...
Path("reports/paper/bt_optimized.json").write_text(json.dumps(out, indent=2, ensure_ascii=False))
print(f"\n✅ 详细数据保存到 reports/paper/bt_optimized.json")