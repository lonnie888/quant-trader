...
PARAMS = {
    ...
    "stop_loss_pct": 0.12, "take_profit_pct": 0.30,
    "side": "long_only",
}
...
print(f"  take_profit_pct:           0.30 (30%止盈)")
...
Path("reports/paper/bt_bars_since70.json").write_text(json.dumps(out, indent=2, ensure_ascii=False))
print(f"\n✅ 详细数据保存到 reports/paper/bt_bars_since70.json")