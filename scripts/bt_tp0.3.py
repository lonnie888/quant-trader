...
PARAMS = {
    ...
    "stop_loss_pct": 0.12, "take_profit_pct": 0.3,
    "side": "long_only",
}
...
Path("reports/paper/bt_tp0.3.json").write_text(json.dumps(out, indent=2, ensure_ascii=False))
print(f"\n✅ 详细数据保存到 reports/paper/bt_tp0.3.json")